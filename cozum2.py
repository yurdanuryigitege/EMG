...
# Excelden mahalle bilgilerini al
...
def en_yakin_komsu(mesafeler):
    ...
    rota.append(0)  # Başladığı yere dön
    return rota
...
tsp_konumlar = [konumlar[i] for i in rota_sirasi]
...
# Mesafe bilgisini gösteren yazı
...
# Haritayı kaydet
harita.save("harita_tsp.html")
print("Harita 'harita_tsp.html' olarak kaydedildi.")
